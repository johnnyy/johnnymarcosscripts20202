...
SG_ID=$(aws ec2 create-security-group --description "Script SG" --group-name "johnny-sg-atv14" --query "GroupId" --vpc-id ${VPC_ID} --output text)
...
sleep 12 # Para dar tempo de instalar os pacotes e passar html, pq se não, vai aparecer o padrão do Apache
